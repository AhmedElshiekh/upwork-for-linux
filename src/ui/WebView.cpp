...
namespace wfl::ui
{
    namespace
    {
        constexpr auto const UPWORK_WEB_URI = "https://www.upwork.com/";
        ...
        gboolean permissionRequest(WebKitWebView*, WebKitPermissionRequest* request, GtkWindow*)
        {
            ...
            dialog.set_secondary_text("Do you allow Upwork to send you notifications?");
        ...
        void initializeNotificationPermission(WebKitWebContext* context, gpointer)
        {
            ...
            {
                auto const origin = webkit_security_origin_new_for_uri(UPWORK_WEB_URI);
        ...
        , m_signalNotificationClicked{}
    {
        ...
        webkit_web_view_load_uri(*this, UPWORK_WEB_URI);
    }
    ...
    {
        sendRequest("upwork://send?phone=" + phoneNumber);
    }
