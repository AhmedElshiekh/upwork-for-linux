...
namespace wfl::util
{
    namespace
    {
        ...
        auto const CONFIG_APP_DIR                        = CONFIG_DIR +  "/upwork-for-linux";
        auto const CONFIG_FILE_PATH                      = CONFIG_APP_DIR + "/settings.conf";
        auto const AUTOSTART_DESKTOP_FILE_PATH           = CONFIG_DIR + "/autostart/upwork-for-linux.desktop";
        ...
        constexpr auto const POSSIBLE_DESKTOP_FILE_PATHS = {
            "/usr/local/share/applications/upwork-for-linux.desktop",
            "/usr/share/applications/upwork-for-linux.desktop",
            "/snap/upwork-for-linux/current/share/applications/upwork-for-linux.desktop"
        };
    }
